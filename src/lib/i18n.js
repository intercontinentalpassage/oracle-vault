...
export const I18N = {
  en: {
    ...
    buyInTelegramPosting: "Posting…",
    buyInTelegramOr: "or",
    buyInTelegramHint: "Posts your numbers to our public Telegram channel. No name or phone needed.",
    buyInTelegramSent: "Posted to our Telegram channel!",
    buyInTelegramSentDetail: "We'll reply as a comment on your post. Open it in Telegram to see our reply.",
    openTelegramPost: "Open the post in Telegram",
    buyInTelegramFailed: "Couldn't post to Telegram. Please try again.",
    statusExpired: "Sold out",
    statusExpiredDetail: "Someone else bought these numbers first.",
    soldOutNumbers: "Sold out: {n}",
    agentCodeNotFound: "That agent code or email wasn't found — check it, or leave it blank to continue without one.",

...
export const I18N = {
  en: {
    ...
    ticketsCountTotal: "{count} ticket(s) · ฿{total} total. These tickets are on hold while it's reviewed.",
    done: "Done",
  ...
  my: {
    ...
    ticketsCountTotal: "လက်မှတ် {count} စောင် · စုစုပေါင်း ฿{total} — ဤလက်မှတ်များကို စိစစ်နေစဉ် ယာယီဖယ်ထားပါသည်။",
    done: "ပြီးပါပြီ",
  ...
  th: {
    ...
    ticketsCountTotal: "สลาก {count} ใบ · รวม ฿{total} — สลากเหล่านี้ถูกกันไว้ระหว่างตรวจสอบ",
    done: "เสร็จสิ้น",
